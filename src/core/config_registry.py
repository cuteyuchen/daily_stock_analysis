...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "BAIDU_SEARCH_API_KEYS": {
        "title": "Baidu Search API Keys",
        "description": "Comma-separated Baidu Search API keys.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
    ...
    "BAIDU_SEARCH_BASE_URL": {
        "title": "Baidu Search Base URL",
        "description": "Baidu Search API endpoint URL.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "https://qianfan.baidubce.com/v2/ai_search/chat/completions",
        "options": [],
        "validation": {
            "item_type": "url",
    ...
    "BAIDU_SEARCH_HTTP_METHOD": {
        "title": "Baidu Search HTTP Method",
        "description": "HTTP method used by the Baidu Search API request.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "select",
        "is_sensitive": False,
