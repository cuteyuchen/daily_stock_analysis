...
const fieldTitleMap: Record<string, string> = {
  ...
  BAIDU_SEARCH_API_KEYS: 'Baidu Search API Keys',
  BAIDU_SEARCH_BASE_URL: 'Baidu Search Base URL',
  BAIDU_SEARCH_HTTP_METHOD: 'Baidu Search HTTP Method',
...
const fieldDescriptionMap: Record<string, string> = {
  ...
  BAIDU_SEARCH_API_KEYS: '用于中文财经热点检索的 Baidu Search 密钥，支持逗号分隔多个。',
  BAIDU_SEARCH_BASE_URL: 'Baidu Search 接口地址。通常保持默认即可，只有切换网关或代理时才需要修改。',
  BAIDU_SEARCH_HTTP_METHOD: 'Baidu Search 调用使用的 HTTP 方法，默认 POST。',
